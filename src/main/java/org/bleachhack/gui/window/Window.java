...
public class Window {
	...
	public void render(DrawContext context, int mouseX, int mouseY) {
		...
		/* window title */
		context.drawTextWithShadow(MinecraftClient.getInstance().textRenderer, title,
	...
	protected void drawBackground(DrawContext context, int mouseX, int mouseY, TextRenderer textRend) {
		...
		context.drawText(MinecraftClient.getInstance().textRenderer, "x", x2 - 11, y1 + 2, -1, false);

		context.drawText(MinecraftClient.getInstance().textRenderer, "_", x2 - 21, y1 + 2, 0, false);
		context.drawText(MinecraftClient.getInstance().textRenderer, "_", x2 - 22, y1 + 1, -1, false);
	}
