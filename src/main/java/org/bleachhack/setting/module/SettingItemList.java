...
public class SettingItemList extends SettingList<Item> {
	...
	@Override
	public void renderItem(MinecraftClient mc, DrawContext context, Item item, int x, int y, int w, int h) {
		if (item == null || item == Items.AIR) {
			...
			context.drawItem(new ItemStack(item), (int) ((x + 1) * offset), (int) ((y + 1) * offset));
